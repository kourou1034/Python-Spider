...
class HouseSpider(scrapy.Spider):
	name = 'lianjia_chengjiao_nanjing'
	allowed_domains = ['nj.lianjia.com/']
	start_urls = ['https://nj.lianjia.com/chengjiao/gulou/',
	'https://nj.lianjia.com/chengjiao/jianye/',
	'https://nj.lianjia.com/chengjiao/qinhuai/',
	'https://nj.lianjia.com/chengjiao/xuanwu/',
	'https://nj.lianjia.com/chengjiao/yuhuatai/',
	'https://nj.lianjia.com/chengjiao/qixia/',
	'https://nj.lianjia.com/chengjiao/jiangning/',
	'https://nj.lianjia.com/chengjiao/pukou/',
		...
		for i in range(1,6):
			try:
				for n in range(1,101):
					try:
						page_url = 'https://nj.lianjia.com'+area_href+'pg'+str(n)+'lc'+str(i)+'/'
